...
Test-FileContains "references/ui-plus-installation.md" "1.0.37"
Test-FileContains "references/map-component-guide.md" "addPoint"
Test-FileContains "references/map-component-guide.md" "地图选点"
Test-FileContains "references/map-component-guide.md" "payload.coordinate.x"
Test-FileContains "references/map-component-guide.md" "单点选址不得使用"
...
Test-FileContains "references/map-component-guide.md" "updatePointMarker"
Test-FileContains "references/map-component-guide.md" "clusterTextAlign"
